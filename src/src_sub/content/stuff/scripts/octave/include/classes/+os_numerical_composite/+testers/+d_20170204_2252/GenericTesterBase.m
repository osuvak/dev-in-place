...
%          flag_plottable        = 0;
    ...
    methods(Access=public)
        ...
        function obj = GenericTesterBase(varargin)
            ...
            obj.flag_in_realquick     = 0;
            obj.flag_expected_to_fail = 0;
            obj.flag_plottable        = 0;
...
%      end
    ...
    % should be implemented in child class, therefore abstract (octave does not allow this!)
    methods(Access=public)
